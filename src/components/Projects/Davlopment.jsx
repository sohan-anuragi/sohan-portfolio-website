      ...
      <div
        ...
        className={`mt-[1rem] max-w-[22rem] shadow-lg ${
          ...
          isVisible
            ...
            : "sm:-translate-x-[30rem] -translate-x-[15rem] opacity-0"
        }`}
      >
        ...
        <div>
          ...
          <div className="mt-[1rem] p-[0.3rem] pt-[0.5rem] flex">
            ...
            <a
              ...
              className={`${
                themeToggle ? "text-[white] bg-[red]" : "text-[white] bg-[red]"
              } hover:text-[black] hover:bg-gradient-to-r from-gray-100 to-gray-300  transition-colors duration-300 ease-in-out p-[0.4rem] rounded-[17px] pl-[1rem] pr-[1rem] flex items-center w-[6.5rem] justify-between ml-[0.5rem]`}
            >
              <span>
                <IoLogoGithub />
              </span>
